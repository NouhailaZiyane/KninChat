...
<body>
	<img src="logo1.png" width="120px" height="100px">
		                    ...
		                    <div class="row">
			                    <div id="f"> 
				                    <div class="from-inline p-3">
					                    <input  type="text" name="search" id="search" class="form-control" placeholder="Search KninChat"><br>
					              
					                    <div  style="position:relative;margin-top:-20px;margin-left:-30px;width: 400px; " >
