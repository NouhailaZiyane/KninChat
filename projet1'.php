...
<body>
   ...
   <div class="row">
  <div class="col-12">
    <input type="email" class="form-control" placeholder="Email" name="email" id="email" required="required"  ></div></div>
    <div class="row">
  <div class="col-12">
    <p><a href="projet1.php">Utiliser un numéro de téléphone</a></p></div></div>
...
<div class="row"><div class="col-lg-5 col-12"></div><div class="col-12 col-lg-5"><input type="submit" name="submit"   class="form-submit-button" role="button" value="Suivant"></div></div>
</form></div></div></div>
